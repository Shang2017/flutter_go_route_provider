...
class DetailRoutes {
  ...
  static const String eightPath = '/eight';
  ...
  static const String eightNamed = 'eight_page';
   ...
   static List<RouteIndex> index = [
    ...
    RouteIndex(eightPath,eightNamed,
            (context, state) => eightPage(),
            Icon(Icons.settings_outlined),Text('eight'), 
            (context){
              GoRouter.of(context).push(DetailRoutes.eightPath);
            },),               
  ];
}